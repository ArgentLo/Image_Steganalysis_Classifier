...
class Srnet_Base(nn.Module):
	def __init__(self, in_channels):
		...
		self.layer1 = nn.Conv2d(in_channels=in_channels, out_channels=128,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn1 = nn.BatchNorm2d(128)
		# Layer 2
		self.layer2 = nn.Conv2d(in_channels=128, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn2 = nn.BatchNorm2d(32)
		# Layer 3
		self.layer31 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn31 = nn.BatchNorm2d(32)
		self.layer32 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn32 = nn.BatchNorm2d(32)
		# Layer 4
		self.layer41 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn41 = nn.BatchNorm2d(32)
		self.layer42 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn42 = nn.BatchNorm2d(32)
		# Layer 5
		self.layer51 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn51 = nn.BatchNorm2d(32)
		self.layer52 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn52 = nn.BatchNorm2d(32)
		# Layer 6
		self.layer61 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn61 = nn.BatchNorm2d(32)
		self.layer62 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn62 = nn.BatchNorm2d(32)
		# Layer 7
		self.layer71 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn71 = nn.BatchNorm2d(32)
		self.layer72 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn72 = nn.BatchNorm2d(32)
		# Layer 8
		self.layer81 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=1, stride=2, padding=0, bias=False)
		self.bn81 = nn.BatchNorm2d(32)
		self.layer82 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn82 = nn.BatchNorm2d(32)
		self.layer83 = nn.Conv2d(in_channels=32, out_channels=32,
			kernel_size=3, stride=1, padding=1, bias=False)
		self.bn83 = nn.BatchNorm2d(32)
		self.pool1 = nn.AvgPool2d(kernel_size=3, stride=2, padding=1)
		# Layer 9
		self.layer91 = nn.Conv2d(in_channels=32, out_channels=64,
			kernel_size=1, stride=2, padding=0, bias=False)
		self.bn91 = nn.BatchNorm2d(64)
		self.layer92 = nn.Conv2d(in_channels=32, out_channels=64,
			kernel_size=3, stride=1, padding=1, bias=False)
